...
- (void)loadData
{
    ...
    self.cellArray = [@[@{ @"image":image1, @"name":@"旁友，不一起去踏青吗？", @"time":@"3月30日0:00-13:00" },
                        @{ @"image":image2, @"name":@"零基础吉他教学体验", @"time":@"5月18日14:00-17:00" },
                        @{ @"image":image3, @"name":@"走，春游去！沉浸在草莓的乐园", @"time":@"4月20日13:00-17:00" },
                        @{ @"image":image4, @"name":@"推挤碰撞！释放压力吧！泡泡足球！", @"time":@"4月16日14:00-16:00" }] mutableCopy];
    
    self.data = [@[@{ @"image":image1, @"title":@"旁友，不一起去踏青吗？", @"time":@"3月30日0:00-13:00", @"yuanjixiaoji":@"院级", @"place":@"上方山森林公园", @"cost":@"免费", @"detail":@"最近天气好的很哪，我们踏青去。上方山百花节好！走出宿舍赏花去！上方山山上的露天“金光大佛”非常醒目，但原先到金光大佛的索道现已停运，游客可沿步道拾级而上，上方山海拔仅92米，徒步登山就当锻炼身体啦。宋代的楞枷塔则是上方山的地标和最高点，还有治平 寺、石湖草堂、乾隆御道等古迹。此外，这里也有孔雀园、各类植物园，并设有专门的拓展及烧烤场地。导览：从位于吴越路的北段的公园主入口进园，右前方是古 迹治平寺和石湖草堂，如果往右直走可到石佛寺、范成大祠以及北入口。从主入口往左走可依次到金光大佛、孔雀园、拓展基地，沿途还会经过几个大草坪和植物园，继续再往前走便可登上上方山参观楞枷塔。" },
